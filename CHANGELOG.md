...
### Added
- report-detail: New `--project` (`-p`) option to filter by project name (substring match, case-insensitive). When used, only matching work events are shown (absences are hidden).
...
### Added
- list: New `--detail` (`-d`) option to show event notes/messages for scheduled events (fetches detail from the API per event)

### Changed
- init: Replaced `fetchClients` with `getClients` API helper (parameter order aligned with other API functions)
...
[1.9.5]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.9.4...v1.9.5
[1.9.4]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.9.3...v1.9.4
[1.9.3]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.9.2...v1.9.3
[1.9.2]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.9.1...v1.9.2
[1.9.1]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.9.0...v1.9.1
[1.9.0]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.10...v1.9.0
[1.8.10]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.9...v1.8.10
[1.8.9]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.8...v1.8.9
[1.8.8]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.7...v1.8.8
[1.8.7]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.6...v1.8.7
[1.8.6]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.5...v1.8.6
[1.8.5]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.4...v1.8.5
[1.8.4]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.3...v1.8.4
[1.8.3]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.2...v1.8.3
[1.8.2]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.1...v1.8.2
[1.8.1]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.8.0...v1.8.1
[1.8.0]: https://github.com/tomasbruckner/sloneek-cli/compare/v1.7.2...v1.8.0
